...
![mvc-4-3.png](img/mvc-4-3.png)

**(중요)** `handler` 를 자세히 보면 따로 정해진 타입이 없고 `Object` 타입이다.

![mvc-4-4.png](img/mvc-4-4.png)
